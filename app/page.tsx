          ...
          <ContainerScroll
            titleComponent={
              <div className="flex items-center justify-center flex-col">
                ...
                <h1 className=" text-4xl md:text-8xl bg-clip-text text-transparent bg-gradient-to-b from-white to-neutral-500 font-sans font-bold">Automate your work with Fuzzie
                </h1>
              </div>}>
          </ContainerScroll>
        </div>
